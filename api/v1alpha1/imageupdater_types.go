...
type ImageUpdaterStatus struct {
	...
	// conditions represent the current state of the ImageUpdater resource.
...
type ImageUpdater struct {
	...
	// spec defines the desired state of ImageUpdater
	// +required
	Spec ImageUpdaterSpec `json:"spec"`

	// status defines the observed state of ImageUpdater
	// +optional
	Status ImageUpdaterStatus `json:"status,omitzero"`
}
